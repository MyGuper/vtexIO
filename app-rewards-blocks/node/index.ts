...
import { getForm } from './middlewares/getForm'
import { postForm } from './middlewares/postForm'
import { rewards } from './middlewares/rewards'
...
export default new Service({
  ...
  routes: {
    ...
    rewards: method({
      POST: [bodyParser, rewards],
    }),

    getForm: method({
      GET: [bodyParser, getForm],
    }),

    postForm: method({
      POST: [bodyParser, postForm],
    }),
  },
})
